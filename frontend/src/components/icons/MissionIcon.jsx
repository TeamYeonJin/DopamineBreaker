function MissionIcon({ color = '#A7A7A7', size = 24 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      />
      <path d="M12 5.48999V20.49V5.48999Z" fill={color}/>
      <path d="M12 5.48999V20.49" stroke="white" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M7.75 8.48999H5.5H7.75Z" fill={color}/>
      <path d="M7.75 8.48999H5.5" stroke="white" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M8.5 11.49H5.5H8.5Z" fill={color}/>
      <path d="M8.5 11.49H5.5" stroke="white" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  )
}
